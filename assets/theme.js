      ...
      value: function _fetchProducts() {
        ...
        fetch(window.theme.localeRootUrl + '/search?view=recently-viewed-products&type=product&q=' + queryString, {
          ...
          response.text().then(function (content) {
            ...
            // Set the content
            _this57.element.innerHTML = tempElement.querySelector('.Section').innerHTML;

            // Show the section
            _this57.element.parentNode.style.display = 'block';
    ...
    _createClass(ShopTheLookSection, [{
      ...
      value: function _createOuterCarousel() {
        ...
        __WEBPACK_IMPORTED_MODULE_2__helper_Dom__["default"].nodeListToArray(this.element.querySelectorAll('.ShopTheLook__ProductList')).forEach(function (item) {
          ...
          _this62.innerCarousels[lookIndex].push(new __WEBPACK_IMPORTED_MODULE_0__components_Carousel__["default"](item, { onSelect: _this62._onProductChanged.bind(_this62) }));
...
// $(".ProductForm__Item").change(function() {
//   alert("dsf");
