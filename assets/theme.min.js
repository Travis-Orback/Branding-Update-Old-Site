...
, function(e, t, n) {
      ...
      , l = function() {
        ...
        return _createClass(e, [{
            ...
            value: function(e, t) {
                ...
                //Bold QB Grid Update
                var grid = document.querySelector('.bold_qb_grid');

              	if(grid){
                  if(t.qb_lookup && t.qb_lookup.grid)
                    grid.innerHTML = t.qb_lookup.grid;
                  else
                    grid.innerHTML = ""; 
                }
    ...
    BOLD.common.eventEmitter.emit("BOLD_COMMON_variant_changed");
            ...
            BOLD.common.eventEmitter.emit('BOLD_COMMON_variant_changed', { variant: this.currentVariant });
